...
public class KafkaConsumerConfig {
    ...
    @Bean
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, EmailMessage>> factory (ConsumerFactory<String, EmailMessage> consumerFactory) {
